Pod::Spec.new do |s|
  ...
  s.author       = { "Peter Paulis" => "peter@min60.com", "Michael Harrison" => "michael.harrison@cru.org" }
  s.source       = { :git => "https://github.com/CruGlobal/M6ParallaxController.git", :tag => "0.0.1" }
  s.platform     = :ios, '5.0'
